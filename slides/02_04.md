...
- We'll need to move the data from our apts variable and use the created lifecycle hook in our app. Let's start by cutting the data out of here and before we move it, I'm going to go to the [JSON Editor Online](http://jsoneditoronline.org/) site so that you can see the structure of the data a bit better.
...
- Github
  - [Start](https://github.com/planetoftheweb/vueinterface/tree/02_04b?trk=insiders_6787408_learning), [Finished](https://github.com/planetoftheweb/vueinterface/tree/02_04e?trk=insiders_6787408_learning), [Changes](https://github.com/planetoftheweb/vueinterface/compare/02_03e...02_04e?trk=insiders_6787408_learning)
